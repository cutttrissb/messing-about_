ActionController::Routing::Routes.draw do |map|
  map.resources :product_archives
  ...
  # Added line to map product 'search' functionality
  map.products 'products', :controller => 'products', :action => 'search'
